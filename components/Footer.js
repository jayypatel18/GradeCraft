      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-6 md:mb-0">
            <h3 className="text-xl font-bold mb-2">GradeCraft</h3>
            ...
            <ul className="space-y-2">
              <li>
                <a 
                  ...
                  className="text-indigo-200 hover:text-white transition flex items-center"
                >
        ...
        <div className="mt-8 pt-6 border-t border-indigo-600 text-center">
          <p className="text-indigo-200">
